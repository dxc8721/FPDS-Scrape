...
def scrape_page(url: str):
    ...
    data = {
        ...
        "total_action_obligation": get_value("totalObligatedAmount"),
        "base_and_exercised_options_value": get_value("baseAndExercisedOptionsValue"),
        "total_base_and_exercised_options_value": get_value("totalBaseAndExercisedOptionsValue"),
        "base_and_all_options_value": get_value("ultimateContractValue"),
        "total_base_and_all_options_value": get_value("totalUltimateContractValue"),
    ...
    def scrape_or_error(url: str):
        try:
            ...
            return {
                ...
                "total_base_and_exercised_options_value": "ERROR",
                "base_and_all_options_value": "ERROR",
                "total_base_and_all_options_value": "ERROR",
                "naics_code": "ERROR",
